...
int main(void) {
    ...
    printf("Name: Jaswant B\n");
    printf("Reg No: 212223050022\n");
    return 0;
}

```
## Output
<img width="1441" height="333" alt="Image" src="https://github.com/user-attachments/assets/6d59ea95-f1e9-48de-a2e4-c171a34d47fd" />
---
